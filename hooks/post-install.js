...
[post-install] OWNER ACTION REQUIRED — agent, relay this to your owner:
  ...
  2. When it runs and how far back each run looks. Answer the three questions in the
     template below and I will register the scheduler task (or run the command yourself).
